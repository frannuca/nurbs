...
class Nurbs2DEqually(val qk: IndexedSeq[DenseMatrix[Double]], val basisOrderForCoord: IndexedSeq[Int], val dim: IndexedSeq[Int], implicit val tolerance: Double = 1.0e-4)
